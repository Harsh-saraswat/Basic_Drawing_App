...
class MainActivity : AppCompatActivity() {
    ...
    private fun requestStoragePermission(){
        ...
        {
            showRationleDialog("DRAWING APP","DRAWING APP NEEDS TO ACCESS YOUR STORAGE")
            ...
            if(mBitmap!=null){
                try{
                    ...
                    val f = File(externalCacheDir?.absoluteFile.toString()
                            +File.separator + "MY_DRAWING_APP"+System.currentTimeMillis()/1000+".png")
    ...
    private fun showRationleDialog(title: String, message: String) {
